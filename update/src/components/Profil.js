...
const Profil = () => {
    ...
    useEffect(() => {
        ...
        url: `https://api.betaseries.com/oauth/access_token?client_id=be42888c11dd&client_secret=4f84b96f582fe7838ae1814d287bbc9b&redirect_uri=http://localhost:3000/profil&code=${code}`,
        headers: { },
        data : data
        };
